    ...
    public static class GlobalHotKey
    {
        ...
        public static void Awake()
        {
            ...
            if (WindowhWnd != IntPtr.Zero)
            {
                ...
                {
#if NETFRAMEWORK
                    var hash = FrameworkSupport.HashCombine(meta.Item1, meta.Item2);
#elif NET
        ...
        public static int Register(IHotKeyComponent component)
        {
            ...
            {
#if NETFRAMEWORK
                var id = FrameworkSupport.HashCombine(component.VirtualModifiers, component.VirtualKeys);
#elif NET
        ...
        public static int Register(uint modifiers, uint triggers, params HotKeyEventHandler[] handlers)
        {
            ...
            {
#if NETFRAMEWORK
                var id = FrameworkSupport.HashCombine(modifiers, triggers);
#elif NET
